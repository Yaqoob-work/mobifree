...
//   final String contentId; // Add contentId field
//   String type;
//   String status;
...
//       contentType: json['content_type']?.toString() ?? 'N/A',
//       contentId: json['content_id']?.toString() ?? json['id']?.toString() ?? '0',
...
//               isSearch: false,videoId:int.tryParse(channels[index].id) ,
//             ),
//           ),
//         ),
//       );
...
//                               videoId:int.tryParse(widget.filteredChannels[index].id) ,
//                             ),
//                           ),
//                         ).then((_) {
//                           setState(() {
