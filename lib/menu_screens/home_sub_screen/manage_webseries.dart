...
// import '../../widgets/focussable_webseries_widget.dart';
// import '../../widgets/models/news_item_model.dart';
...
//   List<dynamic> _categories = []; // Same as your `categories`
...
//   } catch (e) {
//     setState(() {
//       _errorMessage = "Failed to load webseries";
//       _isLoading = false;
//     });
//   }
// }
...
//     if (response.statusCode == 200) {
//       final List<dynamic> flatData = jsonDecode(response.body);
//       // Group by tag, just like your old code
//       final Map<String, List<dynamic>> grouped = {};
//       for (var item in flatData) {
//         final tagName = item['custom_tag']?['custom_tags_name'] ?? 'Unknown';
//         grouped.putIfAbsent(tagName, () => []).add(item);
//       }
//       // Make [{id, category, web_series:[…]}, …]
//       final List<Map<String, dynamic>> newCats = grouped.entries.map((e) => {
//         'id': e.value.first['custom_tag']?['custom_tags_id'] ?? '0',
//         'category': e.key,
//         'web_series': _sortByIndex(e.value), // index sorting
//       }).toList();
...
//     }
//   } catch (e) {
//     // Ignore error (background)
//   } finally {
//     setState(() { _isLoading = false; });
//   }
// }

// // Helper to sort by index field
// List<dynamic> _sortByIndex(List<dynamic> list) {
//   list.sort((a, b) =>
//       (int.tryParse(a['index'] ?? '0') ?? 0).compareTo(int.tryParse(b['index'] ?? '0') ?? 0));
//   return list;
// }
