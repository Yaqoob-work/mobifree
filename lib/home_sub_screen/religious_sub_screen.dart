...
class ReligiousSubScreen extends StatefulWidget {
  @override
  _ReligiousSubScreenState createState() => _ReligiousSubScreenState();
}

class _ReligiousSubScreenState extends State<ReligiousSubScreen> {
