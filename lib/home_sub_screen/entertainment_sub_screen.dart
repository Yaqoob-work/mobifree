...
class EntertainmentSubScreen extends StatefulWidget {
  @override
  _EntertainmentSubScreenState createState() => _EntertainmentSubScreenState();
}

class _EntertainmentSubScreenState extends State<EntertainmentSubScreen> {
